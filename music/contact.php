    ...
    <div class="wrapper">
        ...
        <nav>
            ...
            <ul class="nav-links">
                ...
                <li><a href="./contact.php" id="active""><b>Контакты</b></a></li>
            </ul>
            </b>
        </nav>
        <div class="branches-wrapper">
            <div class="d1">
                ...
                <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Abef44881044fc50c7497a78a75e68144c46f559f7692ba8a400f510fb8e05055&amp;source=constructor" width="40%" height="240" frameborder="0"></iframe>    
            </div>
            <div class="d1">
                <div class="branches">
                ...
                <<iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A788477de46788f68222ce6655eb0ad8fac2ef6259616845532a531c6ebae7eab&amp;source=constructor" width="40%" height="240" frameborder="0"></iframe>
                </div>
            <div class="cont1">
                <h1>Контактные данные для обратной связи</h1>
                <div class="social-media">
                <div class="mail"><a href="mailto:pwsshop@yandex.ru">semen251203p@yandex.ru</a></div>
                <div class="tphone"><a href="tel:89040834163">89040834162</a></div>
                </div>
            </div>
            <div class="cont2">
    ...
    <footer>
        <div class="sections">
            ...
            <div class="about-shipping">
                <h2>Доставка</h2>
                <p>Наши партнеры по доставке пользуются хорошей репутацией и доверием, и мы тесно сотрудничаем с ними, чтобы гарантировать, что ваши заказы будут обработаны с осторожностью и доставлены вовремя</p>
            </div>
            <div class="faq">
                <h2>FAQ</h2>
                    <ul>
